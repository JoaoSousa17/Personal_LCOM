...
int game_start_letter_rain(jogo_t *game) {
  ...
  if (init_result != 0) {
    ...
    /* Em caso de erro, criar um estado válido mínimo */
    game->letter_rain_game.caught_letter = 'A'; /* Letra padrão */
  ...
  return 0; /* Sempre retorna sucesso para evitar falhas críticas */
}
